...
#
# Generated by export_simulation on Sun Dec 11 15:16:33 EST 2016
#
################################################################################
...
switch to the './characterBRAM2.sh' script.

./characterBRAM2.sh -reset_run
...
./characterBRAM2.sh -noclean_files

For more information on the script, please type './characterBRAM2.sh -help'.

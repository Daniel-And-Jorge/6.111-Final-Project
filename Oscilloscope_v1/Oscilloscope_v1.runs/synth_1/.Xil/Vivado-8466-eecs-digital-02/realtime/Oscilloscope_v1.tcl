...
set rt::rc [catch {
  uplevel #0 {
    ...
    set ::env(RT_TMP) "./.Xil/Vivado-8466-eecs-digital-02/realtime/tmp"
    ...
    if {$rt::useElabCache == false} {
      ...
      ./.Xil/Vivado-8466-eecs-digital-02/realtime/blk_mem_gen_0_stub.v
      ./.Xil/Vivado-8466-eecs-digital-02/realtime/CharactersROM_stub.v
      ./.Xil/Vivado-8466-eecs-digital-02/realtime/clk_wiz_0_stub.v
    ...
    set rt::SDCFileList ./.Xil/Vivado-8466-eecs-digital-02/realtime/Oscilloscope_v1_synth.xdc
    rt::sdcChecksum
...
# MODE: 
    ...
    rt::set_parameter enableSplitFlowPath "./.Xil/Vivado-8466-eecs-digital-02/"
